...
public:
    string serialize;
    int deltaX,deltaY;
    Direction(string serialize,int deltaX,int deltaY);
};

Direction* UP = new Direction("UP",-1,0);
Direction* DOWN = new Direction("DOWN",1,0);
Direction* LEFT = new Direction("LEFT",0,-1);
Direction* RIGHT = new Direction("RIGHT",0,1);
Direction* STAY = new Direction("",0,0);
...
Direction::Direction(string serialize, int deltaX, int deltaY) {
    this->deltaX = deltaX;
    this->deltaY = deltaY;
